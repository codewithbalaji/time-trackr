    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute top-3 right-3 rounded-lg p-1 text-muted-foreground outline-none transition-colors hover:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50"
        >
          <X className="size-4" />
