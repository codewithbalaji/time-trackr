...
- Built incrementally by phase (see `docs/roadmap.md`); do not implement future-phase functionality ahead of schedule.
...
- `docs/roadmap.md` — phase-by-phase development plan; current build state is Phase 1 complete.
